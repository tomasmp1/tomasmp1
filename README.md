...
|----------|--------------|-------|
| [**Stroke Prediction Using Machine Learning**](https://github.com/tomasmp1/stroke-prediction) | End-to-end machine learning project predicting stroke risk from patient demographic and health data. Includes exploratory data analysis, feature engineering, preprocessing pipelines, and model comparison (Logistic Regression, KNN, Random Forest, XGBoost) with hyperparameter tuning and evaluation using F1, precision, recall, and ROC-AUC. | Python, pandas, NumPy, scikit-learn, XGBoost, seaborn, matplotlib |
